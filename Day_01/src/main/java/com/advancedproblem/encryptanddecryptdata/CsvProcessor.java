package com.advancedproblem.encryptanddecryptdata;
...
public class CsvProcessor {
    ...
    public static void writeEncryptedCsv() {
        List<String[]> employees = Arrays.asList(
                new String[]{"101", "Riya Soni", "IT", "john.doe@example.com", "60000"},
                new String[]{"102", "Pragya Sable", "HR", "jane.smith@example.com", "55000"},
                new String[]{"103", "Shubhi Verma", "Finance", "alice.brown@example.com", "70000"},
                new String[]{"104", "Sakshi Sharma", "IT", "bob.white@example.com", "65000"},
