package com.advancedproblem.csvfromdatabase;
...
public class DatabaseToCSV {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/riya";
    private static final String USERNAME = "riyasoni992";
    private static final String PASSWORD = "Riya@1508";
